...
helm install myrelease-1 --set omsagent.secret.wsid=$workspaceGuid,omsagent.secret.key=workspaceKey,omsagent.env.clusterId=${1} incubator/azuremonitor-containers --kube-context ${2}
