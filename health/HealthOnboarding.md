## Overview
The following documentation outlines the script required to upgrade an existing cluster onboarded to a Log Analytics workspace, to an agent running the workflow that generates health monitor signals into the same workspace. 

* Do a custom off-boarding of the cluster from Monitoring 
* Installing the new agent that generates health monitor signals
* Please refer to the powershell script 
