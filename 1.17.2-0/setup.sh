...
wget https://github.com/microsoft/OMS-Agent-for-Linux/releases/download/OMSAgent_v1.17.2-0/omsagent-1.17.2-0.universal.x64.sh

#create file to disable omi service startup script
touch /etc/.omi_disable_service_control
wget https://github.com/microsoft/Docker-Provider/releases/download/1.0.0-43/docker-cimprov-1.0.0-43.universal.x86_64.sh
chmod 775 $TMPDIR/*.sh
